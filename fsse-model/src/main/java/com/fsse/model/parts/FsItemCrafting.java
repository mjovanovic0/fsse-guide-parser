 ...
 */
@Entity
@Table(name = "FS_ITEM_CRAFTING")
@GenericGenerator(name = "FS_ITEM_CRAFTING_SEQ", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", //
        parameters = { //
                @Parameter(name = "sequence_name", value = "FS_ITEM_CRAFTING_SEQ"), //
                @Parameter(name = "initial_value", value = "1"), //
                @Parameter(name = "increment_size", value = "1") //
        }
)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public class FsItemCrafting {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FS_ITEM_CRAFTING_SEQ")
    private Integer id;
    ...
    @Type(type = "com.fsse.hibernate.CustomEnumType", parameters = { //
            @Parameter(name = "enumClassName", value = "com.fsse.model.attribute.StatType"), //
