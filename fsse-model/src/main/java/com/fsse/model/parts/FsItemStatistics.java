 ...
 */
@Entity
@Table(name = "FS_ITEM_STATISTICS")
@GenericGenerator(name = "FS_ITEM_STATISTICS_SEQ", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", //
        parameters = { //
                @Parameter(name = "sequence_name", value = "FS_ITEM_STATISTICS_SEQ"), //
                @Parameter(name = "initial_value", value = "1"), //
                @Parameter(name = "increment_size", value = "1") //
        }
)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public class FsItemStatistics {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FS_ITEM_STATISTICS_SEQ")
    private Integer id;
